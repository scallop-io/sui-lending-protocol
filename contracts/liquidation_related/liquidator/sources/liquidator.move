...
module scallop_liquidator::liquidator {
  ...
  public fun is_eligible_to_be_liquidated<DebtType, CollateralType>(
  ...
  public fun liquidate_obligation_with_cetus_pool<DebtType, CollateralType>(
    ...
    if (!is_eligible_to_be_liquidated<DebtType, CollateralType>(obligation, market, coin_decimals_registry, x_oracle, clock))
      return;    
  ...
  public fun liquidate_obligation_with_cetus_pool_only_a<DebtType, B>(
    ...
    if (!is_eligible_to_be_liquidated<DebtType, DebtType>(obligation, market, coin_decimals_registry, x_oracle, clock))
      return;
