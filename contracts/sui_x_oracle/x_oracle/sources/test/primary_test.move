...
module x_oracle::primary_test {
    ...
    fun test_primary_for_multiple_prices() {
        ...
        x_oracle::pyth_mock_adapter::update_price_as_primary<SUI>(&mut request_update_sui, 10 * std::u64::pow(10, x_oracle::price_feed::decimals()), 1000);
        x_oracle::supra_mock_adapter::update_price_as_primary<ETH>(&mut request_update_eth, 1000 * std::u64::pow(10, x_oracle::price_feed::decimals()), 1000);
    ...
    fun test_two_primary_error() {
        ...
        let request = x_oracle::price_update_request(&x_oracle);
        x_oracle::supra_mock_adapter::update_price_as_primary<SUI>(&mut request, 10 * std::u64::pow(10, x_oracle::price_feed::decimals()), 1000);
        x_oracle::pyth_mock_adapter::update_price_as_primary<SUI>(&mut request, 10 * std::u64::pow(10, x_oracle::price_feed::decimals()), 1000);
        x_oracle::confirm_price_update_request<SUI>(&mut x_oracle, request, &clock);
