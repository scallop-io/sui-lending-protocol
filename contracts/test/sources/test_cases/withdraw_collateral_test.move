...
module protocol_test::withdraw_collateral_test {
    ...
    public fun withdraw_collateral_without_borrowing_test() {
        ...
        test_scenario::next_tx(scenario, borrower);
        let withdrawed_collateral = withdraw_collateral_t<ETH>(scenario, borrower, &mut obligation, &obligation_key, &mut market, &coin_decimals_registry, eth_amount, &x_oracle, &clock);
    ...
    public fun withdraw_collateral_with_borrowing_test() {
        ...
        let withdrawed_collateral = withdraw_collateral_t<ETH>(scenario, borrower, &mut obligation, &obligation_key, &mut market, &coin_decimals_registry, withdraw_amount, &x_oracle, &clock);
