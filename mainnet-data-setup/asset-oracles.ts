...
export const oracles: Record<SupportedBaseAssets | SupportedCollaterals, OracleData> = {
  ...
  zWBtc: { pythPriceObjectId: pythOracleData.priceFeeds.btc_usd.priceFeedObjectId },
  ...
  mUsd: { pythPriceObjectId: pythOracleData.priceFeeds.usdc_usd.priceFeedObjectId },
