...
export const zWBtcInterestModel: InterestModel = {
  baseBorrowRatePerSec: getRatePerSec(5), // 5%
  interestRateScale,
...
export const USDSUIInterestModel: InterestModel = {
  baseBorrowRatePerSec: getRatePerSec(3), // 3%
  interestRateScale,
  ...
  borrowWeight, // 1
  scale,
  minBorrowAmount: 10 ** (coinDecimals.USDSUI - 2), // 0.01 USDSUI
}

export const XAUmInterestModel: InterestModel = {
  baseBorrowRatePerSec: getRatePerSec(3), // 3%
  interestRateScale,
  ...
  borrowWeight, // 1
  scale,
  minBorrowAmount: 10 ** (coinDecimals.XAUm - 4), // 0.0001 XAUm
}
