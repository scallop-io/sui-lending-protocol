...
export const registerMvr = async () => {
    ...
    const suiNSObjectId = '0x5f1960cae33fad48f4fd52685219bede891e59a33be4ff4d8ae1e42339c19b6f'; // xoracle@scallop
    const packageInfoId = '0xa5ab3240a21aa1d1dfb208a68cad3e14ab5e7c5edf6681667d517ac8764a1395'; // scallop xoracle package info
    ...
    const git = ptb.moveCall({
        ...
        arguments: [
            ...
            ptb.pure.string("contracts/sui_x_oracle/x_oracle"),
    ...
    ptb.moveCall({
        ...
        arguments: [
            ...
            ptb.pure.string("xoracle@scallop/core"),
        ],
    });
