...
export const SupplyLimits: Record<SupportedBaseAssets, number> = {
  ...
  sca: 50e6 * Math.pow(10, coinDecimals.sca),
  ...
  scaSui: 1e6 * Math.pow(10, coinDecimals.scaSui), // 1M
  ...
  zWBtc: 10 * Math.pow(10, coinDecimals.zWBtc),
  ...
  suiUSDe: 1_000_000 * Math.pow(10, coinDecimals.suiUSDe), // 1M
  USDSUI: 1_000_000 * Math.pow(10, coinDecimals.USDSUI), // 1M
  XAUm: 1_000 * Math.pow(10, coinDecimals.XAUm), // 1K
}
